...
impl PveClient {
    ...
    pub async fn create_snapshot(&self, node: &str, vmid: i32, name: &str, description: Option<&str>) -> Result<Value> {
        let url = format!("{}/api2/json/nodes/{}/qemu/{}/snapshot", self.base_url, node, vmid);
